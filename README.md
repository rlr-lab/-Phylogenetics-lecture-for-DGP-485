...
```
iqtree2 -s /projects/e30682/Phylogenetics_DGP485_Materials_Lorenzo/IntraHostHIVenvLiao2013_NoStop_subalign.fasta -T AUTO -B 1000 -pre ./IntraHostHIVenvLiao2013_NoStop_subalign.fasta 
```
